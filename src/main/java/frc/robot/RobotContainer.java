...
// Arm-Intake-Launcher: import frc.robot.subsystems.ArmSubsystem;
import frc.robot.subsystems.SwerveDriveSubsystem;
// Arm-Intake-Launcher: import frc.robot.subsystems.IntakeSubsystem;
// Arm-Intake-Launcher: import frc.robot.subsystems.LauncherSubsystem;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    // is running
    // Arm-Intake-Launcher: m_arm.setDefaultCommand(new RunCommand(() -> m_arm.runAutomatic(), m_arm));

    // set the intake to stop (0 power) when no other command is running
    // Arm-Intake-Launcher: m_intake.setDefaultCommand(new RunCommand(() -> m_intake.setPower(0.0), m_intake));

    // configure the launcher to stop when no other command is running
    // Arm-Intake-Launcher: m_launcher.setDefaultCommand(new RunCommand(() -> m_launcher.stopLauncher(), m_launcher));
  }
